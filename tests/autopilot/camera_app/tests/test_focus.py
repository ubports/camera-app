...
class TestFocus(CameraAppTestCase):
    ...
    def test_focus_valid_and_disappear(self):
        ...
        self.mouse.move(click_coords[0], click_coords[1])
        self.mouse.click()
        ...
        self.mouse.move_to_object(switch_cameras)
        self.mouse.click()
    ...
    def test_move_focus_ring(self):
        ...
        self.mouse.drag(focus_ring_center[0], focus_ring_center[1], drag_end_coords[0], drag_end_coords[1])
